# openapi_client.model.multi_line_string.MultiLineString
...
------------ | ------------- | ------------- | ------------- | -------------
**type** | str,  | str,  |  | [optional] must be one of ["MultiLineString", ] 
**[coordinates](#coordinates)** | list, tuple,  | tuple,  |  | [optional] 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**Point3D**](Point3D.md) | [**Point3D**](Point3D.md) | [**Point3D**](Point3D.md) |  | 
