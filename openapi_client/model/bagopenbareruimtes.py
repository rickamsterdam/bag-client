...
class Bagopenbareruimtes(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["straatcode"]) -> MetaOapg.properties.straatcode: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["straatnaamPtt"]) -> MetaOapg.properties.straatnaamPtt: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["typeOmschrijving"]) -> MetaOapg.properties.typeOmschrijving: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["naamNen"]) -> MetaOapg.properties.naamNen: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["beschrijvingNaam"]) -> MetaOapg.properties.beschrijvingNaam: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_links", "identificatie", "volgnummer", "ligtInWoonplaatsId", "heeftDossierId", "registratiedatum", "straatcode", "straatnaamPtt", "statusCode", "statusOmschrijving", "beginGeldigheid", "eindGeldigheid", "geconstateerd", "typeCode", "typeOmschrijving", "documentdatum", "documentnummer", "naam", "naamNen", "beschrijvingNaam", "bagprocesCode", "bagprocesOmschrijving", "geometrie", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["straatcode"]) -> typing.Union[MetaOapg.properties.straatcode, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["straatnaamPtt"]) -> typing.Union[MetaOapg.properties.straatnaamPtt, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["typeOmschrijving"]) -> typing.Union[MetaOapg.properties.typeOmschrijving, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["naamNen"]) -> typing.Union[MetaOapg.properties.naamNen, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["beschrijvingNaam"]) -> typing.Union[MetaOapg.properties.beschrijvingNaam, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        straatcode: typing.Union[MetaOapg.properties.straatcode, None, str, schemas.Unset] = schemas.unset,
        straatnaamPtt: typing.Union[MetaOapg.properties.straatnaamPtt, None, str, schemas.Unset] = schemas.unset,
        ...
        typeCode: typing.Union[MetaOapg.properties.typeCode, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        typeOmschrijving: typing.Union[MetaOapg.properties.typeOmschrijving, None, str, schemas.Unset] = schemas.unset,
        ...
        naamNen: typing.Union[MetaOapg.properties.naamNen, None, str, schemas.Unset] = schemas.unset,
        beschrijvingNaam: typing.Union[MetaOapg.properties.beschrijvingNaam, None, str, schemas.Unset] = schemas.unset,
