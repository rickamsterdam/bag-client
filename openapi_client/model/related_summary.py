...
class RelatedSummary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "href", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "href", ], str]):
