...
class PaginatedBagstandplaatsenList(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class _embedded(
                    ...
                    class properties:
                        ...
                        class standplaatsen(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['Bagstandplaatsen']:
                                    return Bagstandplaatsen
                        
                            def __new__(
                                cls,
                                _arg: typing.Union[typing.Tuple['Bagstandplaatsen'], typing.List['Bagstandplaatsen']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'standplaatsen':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'Bagstandplaatsen':
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["standplaatsen"]) -> MetaOapg.properties.standplaatsen: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["standplaatsen", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["standplaatsen"]) -> typing.Union[MetaOapg.properties.standplaatsen, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["standplaatsen", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    standplaatsen: typing.Union[MetaOapg.properties.standplaatsen, list, tuple, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> '_embedded':
                    return super().__new__(
