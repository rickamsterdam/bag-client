...
class PaginatedBagbrondocumentenList(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class _embedded(
                    ...
                    class properties:
                        ...
                        class brondocumenten(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['Bagbrondocumenten']:
                                    return Bagbrondocumenten
                        
                            def __new__(
                                cls,
                                _arg: typing.Union[typing.Tuple['Bagbrondocumenten'], typing.List['Bagbrondocumenten']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'brondocumenten':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'Bagbrondocumenten':
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["brondocumenten"]) -> MetaOapg.properties.brondocumenten: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["brondocumenten", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["brondocumenten"]) -> typing.Union[MetaOapg.properties.brondocumenten, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["brondocumenten", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    brondocumenten: typing.Union[MetaOapg.properties.brondocumenten, list, tuple, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> '_embedded':
                    return super().__new__(
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PaginatedBagbrondocumentenList':
        return super().__new__(
            cls,
            *_args,
            page=page,
