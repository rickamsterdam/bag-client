...
class BagbrondocumentenLink(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["href", "title", "documentnummer", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["href", "title", "documentnummer", ], str]):
