...
class PaginatedBagwoonplaatsenList(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class _embedded(
                    ...
                    class properties:
                        ...
                        class woonplaatsen(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['Bagwoonplaatsen']:
                                    return Bagwoonplaatsen
                        
                            def __new__(
                                cls,
                                _arg: typing.Union[typing.Tuple['Bagwoonplaatsen'], typing.List['Bagwoonplaatsen']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'woonplaatsen':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'Bagwoonplaatsen':
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["woonplaatsen"]) -> MetaOapg.properties.woonplaatsen: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["woonplaatsen", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["woonplaatsen"]) -> typing.Union[MetaOapg.properties.woonplaatsen, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["woonplaatsen", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    woonplaatsen: typing.Union[MetaOapg.properties.woonplaatsen, list, tuple, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> '_embedded':
                    return super().__new__(
