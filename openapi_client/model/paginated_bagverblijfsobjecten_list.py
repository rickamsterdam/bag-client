...
class PaginatedBagverblijfsobjectenList(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class _embedded(
                    ...
                    class properties:
                        ...
                        class verblijfsobjecten(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['Bagverblijfsobjecten']:
                                    return Bagverblijfsobjecten
                        
                            def __new__(
                                cls,
                                _arg: typing.Union[typing.Tuple['Bagverblijfsobjecten'], typing.List['Bagverblijfsobjecten']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'verblijfsobjecten':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'Bagverblijfsobjecten':
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["verblijfsobjecten"]) -> MetaOapg.properties.verblijfsobjecten: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["verblijfsobjecten", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["verblijfsobjecten"]) -> typing.Union[MetaOapg.properties.verblijfsobjecten, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verblijfsobjecten", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    verblijfsobjecten: typing.Union[MetaOapg.properties.verblijfsobjecten, list, tuple, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> '_embedded':
                    return super().__new__(
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PaginatedBagverblijfsobjectenList':
        return super().__new__(
            cls,
            *_args,
            page=page,
