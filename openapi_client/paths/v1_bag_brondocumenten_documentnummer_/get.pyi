...
request_query_documentnummer2 = api_client.QueryParameter(
    name="documentnummer",
    style=api_client.ParameterStyle.FORM,
...
request_path_documentnummer = api_client.PathParameter(
    name="documentnummer",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DocumentnummerSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationHaljson = Bagbrondocumenten
SchemaFor200ResponseBodyTextCsv = Bagbrondocumenten
SchemaFor200ResponseBodyApplicationGeojson = Bagbrondocumenten
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bag_brondocumenten_retrieve_oapg(
        self,
...
class BagBrondocumentenRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def bag_brondocumenten_retrieve(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def bag_brondocumenten_retrieve(
        ...
        return self._bag_brondocumenten_retrieve_oapg(
