...
SchemaFor200ResponseBodyApplicationHaljson = Bagverblijfsobjecten
SchemaFor200ResponseBodyTextCsv = Bagverblijfsobjecten
SchemaFor200ResponseBodyApplicationGeojson = Bagverblijfsobjecten
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bag_verblijfsobjecten_retrieve_oapg(
        self,
...
class BagVerblijfsobjectenRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def bag_verblijfsobjecten_retrieve(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def bag_verblijfsobjecten_retrieve(
        ...
        return self._bag_verblijfsobjecten_retrieve_oapg(
