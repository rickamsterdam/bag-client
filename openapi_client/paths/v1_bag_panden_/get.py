...
SchemaFor200ResponseBodyApplicationHaljson = PaginatedBagpandenList
SchemaFor200ResponseBodyTextCsv = PaginatedBagpandenList
SchemaFor200ResponseBodyApplicationGeojson = PaginatedBagpandenList
...
class BagPandenList(BaseApi):
    ...
    def bag_panden_list(
        ...
        return self._bag_panden_list_oapg(
