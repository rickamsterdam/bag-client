...
SchemaFor200ResponseBodyApplicationHaljson = PaginatedBagligplaatsenList
SchemaFor200ResponseBodyTextCsv = PaginatedBagligplaatsenList
SchemaFor200ResponseBodyApplicationGeojson = PaginatedBagligplaatsenList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bag_ligplaatsen_list_oapg(
        self,
...
class BagLigplaatsenList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def bag_ligplaatsen_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def bag_ligplaatsen_list(
        ...
        return self._bag_ligplaatsen_list_oapg(
